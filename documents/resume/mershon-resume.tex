...
\begin{document}
	...
	\namesection{Brooks}{Mershon}{ \urlstyle{same}\url{http://www.brooksmershon.com} \\
	...
	\begin{minipage}[t]{0.66\textwidth} 
		...
		\runsubsection{UNAVCO}
		\descript{| Software Engineer III}
		\location{April 2021 - Present | Boulder, CO}
		...
		\runsubsection{Timber Tiger Aircraft, Inc.}
		\descript{| Test Pilot (Contractor)}
		\location{November 2020 - Present | Boulder, CO}
		\vspace{\topsep} % Hacky fix for awkward extra vertical space
		\begin{tightemize}
		...
		\descript{| Manager and Chief Pilot}
		\location{January 2019 - April 2021 | Boulder, CO}
		\begin{tightemize}
